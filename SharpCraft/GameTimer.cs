...
namespace SharpCraft
{
    internal class GameTimer
    {
        ...
        public GameTimer(float tps)
        {
            this.ticksPerSecond = tps;
            this.lastSyncSysClock = Stopwatch.GetTimestamp();
            this.lastSyncHRClock = DateTime.Now.Ticks / 1000000L;
        }
        ...
        public void updateTimer()
        {
            ...
            long k = DateTime.Now.Ticks / 1000000L;
